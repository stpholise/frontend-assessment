  ...
  return (
    ...
    <div
      className={clsx(
        ...
        { "hidden": !menuState, "flex": menuState }
      )}
    >
      <p className=""> All</p>
      <button
    ...
    <div className={clsx("lg-hidden fixed w-full h-full top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.1)]", {
      'hidden': !menuState,
      'flex':menuState
    })} onClick={() => dispatch(setMenuState(false))}> </div>
    </>
  );
};
