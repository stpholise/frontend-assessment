      ...
      <div className="rounded-lg border border-gray-200 shadow overflow-hidden">
        ...
        <div className="w-full flex gap-0 bg-white">
          ...
          <div className="flex flex-col px-4 py-4">
            ...
            <p className="text-sm font-medium text-gray-500 mt-2"> ⭐{product.rating} ({product.reviews} reviews)</p>
            <div className="py-3 mt-auto">
              <p className="text-sm text-black font-semibold ">Specifications:</p>
              {
            ...
            <div className="py-4  border-gray-200 mt-auto flex gap-4">
              <button onClick={handleAddToCart} className="bg-black text-white text-xs font-medium px-4 py-2 rounded-lg">
                Add to Cart
              </button>
